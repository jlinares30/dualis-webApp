      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2.5 px-3.5 py-1.5 rounded-xl bg-gray-900/90 border border-gray-800 hover:border-gray-700 text-sm font-medium text-gray-200 transition-all duration-200 shadow-sm"
          >
                  ...
                  {workspaces.map((space) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'w-full flex items-center justify-between p-2.5 rounded-xl text-left text-sm transition-all',
                          isSelected
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2.5 pl-2 border-l border-gray-800">
          ...
          <div className="hidden lg:block text-left">
            <span className="block text-xs font-semibold text-gray-200">Jorge Linares</span>
            <span className="block text-[10px] text-emerald-400 flex items-center gap-1">
              <ShieldCheck className="w-3 h-3" /> Pro Partner
            </span>
          </div>
        </div>
      </div>
