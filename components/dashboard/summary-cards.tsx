...
import { Wallet, TrendingUp, TrendingDown, Users, ArrowUpRight } from 'lucide-react';
  ...
  const metrics = [
    {
      ...
      subtext: isCouple ? 'Cuentas compartidas sincronizadas' : 'En 3 cuentas activas',
    },
    {
      title: 'Gastos del Mes',
      amount: isCouple ? 2150000 : 1450000,
      change: '-4.1%',
      isPositive: true, // Spending is down = good
      icon: TrendingDown,
      gradient: 'from-rose-500/10 via-rose-500/5 to-transparent',
      borderColor: 'border-rose-500/20',
      iconBg: 'bg-rose-500/10 text-rose-400 border-rose-500/20',
      subtext: 'Presupuesto mensual bajo control',
    },
    {
      title: isCouple ? 'Balance de Liquidación' : 'Balance Compartido',
      amount: isCouple ? 180000 : 85000,
      change: isCouple ? 'A favor tuyo' : 'Pendiente',
      isPositive: true,
      icon: Users,
      gradient: 'from-indigo-500/10 via-indigo-500/5 to-transparent',
      borderColor: 'border-indigo-500/20',
      iconBg: 'bg-indigo-500/10 text-indigo-400 border-indigo-500/20',
      subtext: isCouple ? 'Sofía te debe $180.000 COP' : 'Tu cuota del mes saldada',
    },
  ];
